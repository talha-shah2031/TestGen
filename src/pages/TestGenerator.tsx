...
const TestGenerator = () => {
  ...
  const [grade, setGrade] = useState("grade9"); // Updated to match the working payload
  ...
  const grades = [
    { value: "grade9", label: "9th Grade", enabled: true }, // Updated to match the working payload
  ...
  const handleGenerateTest = async () => {
    ...
    try {
      ...
      // console.log('Request Payload:', payload); // Debugging line
